...
public class UMLanguage {
    ...
    public static final String ERROR_NO_PERMISSION = ChatColor.RED + "You do not have permission to use this command!";
    public static final String ERROR_PLAYER_NOT_FOUND = ChatColor.RED + "The specified player could not be found!";
